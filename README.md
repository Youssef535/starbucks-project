...
![Screenshot (62)](https://user-images.githubusercontent.com/82522735/205614415-a77b466d-c7c3-4ea8-a83a-b2172cd54012.png)

  <h3 align="center">Starbucks Landing Page</h3>

  <p align="center">
    Transfered UIUX design to HTML5 CSS3 code
    <br />
    <a href="https://github.com/Youssef535/starbucks-project"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="">View Demo</a>
    ·
    <a href='https://github.com/Youssef535/starbucks-project/issues'>Report Bug</a>
    ·
    <a href="https://github.com/Youssef535/starbucks-project/pulls">Request Feature</a>
  </p>
</div>
...
Clone the repository
  ```sh
  git clone https://github.com/Youssef535/starbucks-project.git
  ```
